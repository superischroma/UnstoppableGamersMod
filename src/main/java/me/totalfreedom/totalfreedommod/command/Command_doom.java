...
public class Command_doom extends FreedomCommand
{
    ...
    public boolean run(final CommandSender sender, Player playerSender, Command cmd, String commandLabel, String[] args, boolean senderIsConsole)
    {
        ...
        FUtil.adminAction(sender.getName(), "Swinging the Ban Hammer over " + player.getName(), true);
        FUtil.bcastMsg(player.getName() + " will be completely squashed!", ChatColor.RED);
        ...
        ban.setReason("&6My name is Jeff(Permanent)");
        ...
        new BukkitRunnable()
        {
            ...
            {
                // message
                FUtil.adminAction(sender.getName(), "Perm Banning " + player.getName() + ", IP: " + ip, true);

                // generate explosion
                player.getWorld().createExplosion(player.getLocation(), 0F, false);

                // kick player
                player.kickPlayer(ChatColor.GOLD + "My name is Jeff(Perm Ban):)");
            }
